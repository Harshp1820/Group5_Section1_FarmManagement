...
if (isset($_POST['add_product'])) 
{
	...
	$stmt = $conn->prepare("INSERT INTO products (user_id,name, description, category, price,quantity, image) VALUES (?,?, ?, ?, ?, ?, ?)");
	$stmt->bind_param("issssss", $user_id, $title, $description, $category, $price,$quantity, $image);
