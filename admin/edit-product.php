							...
							<form method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select class="form-control" id="category" name="category" required>
										...
										<option value="POULTRY FARMING" <?php if ($product['category'] == 'POULTRY FARMING') {
																	echo ' selected';
																} ?>>POULTRY FARMING</option>
										<option value="CATTLE FARMING" <?php if ($product['category'] == 'CATTLE FARMING') {
																	echo ' selected';
																} ?>>CATTLE FARMING</option>
										<option value="DAIRY FARMING" <?php if ($product['category'] == 'DAIRY FARMING') {
																	echo ' selected';
																} ?>>DAIRY FARMING</option>
										<option value="BROILER CHICKEN" <?php if ($product['category'] == 'BROILER CHICKEN') {
																	echo ' selected';
